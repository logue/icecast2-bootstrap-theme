    ...
    <html xmlns="http://www.w3.org/1999/xhtml" lang="en" class="h-100" data-bs-theme="auto">
      ...
      <body class="d-flex flex-column h-100">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" class="d-none">
          ...
          <symbol id="bi-ear" viewBox="0 0 16 16">
          ...
          <symbol id="bi-key-fill" viewBox="0 0 16 16">
            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="navbarCollapse">
                <ul class="navbar-nav me-auto mb-2 mb-md-0">
                  <li class="nav-item">
                    <a class="nav-link" href="stats.xsl">Admin Home</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="listmounts.xsl">Mountpoint List</a>
                  </li>
                </ul>
                <ul class="navbar-nav ms-auto mb-2 mb-md-0">
                  <li class="nav-item">
                    <a class="nav-link" href="/status.xsl">
                      <svg width="1em" height="1em" class="bi">
                        <use href="#bi-house-fill" />
                      </svg>
                    </a>
                  </li>
                </ul>
        ...
        <main class="flex-shrink-0">
          <div class="container">
            ...
            <h1 class="mt-3">Moving listeners from
              <var>
                <xsl:value-of select="current_source" />
              </var>
            </h1>
            <div class="card my-3" role="alert">
              <h2 class="card-header">Move to which mountpoint?</h2>
              <div class="card-body">
                <ul class="list-group">
                  <xsl:for-each select="source">
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                      <span>Move from
                        <code>
                          <xsl:copy-of select="$currentmount" />
                        </code> to
                        <code>
                      ...
                      <a href="moveclients.xsl?mount={$currentmount}&amp;destination={@mount}" class="btn btn-primary">Move clients</a>
                    </li>
                  </xsl:for-each>
                </ul>
              </div>
