    ...
    <xsl:for-each select="source">
      <xsl:choose>
        <xsl:when test="listeners">
          ...
          <xsl:if test="video_quality">"video_quality": "<xsl:value-of select="video_quality" />",</xsl:if>
          <xsl:if test="frame_size">"frame_size": "<xsl:value-of select="frame_size" />",</xsl:if>
          <xsl:if test="frame_rate">"frame_rate": "<xsl:value-of select="frame_rate" />",</xsl:if>
          ...
          "current_song": "<xsl:if test="artist"><xsl:value-of select="artist" /> - </xsl:if>
